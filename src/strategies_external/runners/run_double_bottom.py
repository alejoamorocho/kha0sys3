# src/strategies_external/runners/run_double_bottom.py
"""Runner Doble Suelo: backtest con doc + indicator + ATR sweep.

ATR mode reuses the same grid sweep as OOPS/SMA-18 for comparability.
"""
...
def run_double_bottom_backtest(
    symbols: list[str],
    data_dir: str = "data",
    output_path: Path | str = "reports/external/double_bottom_backtest.md",
    ...
    _trades_to_parquet(all_trades, output_path.parent / "double_bottom_trades.parquet")
...
if __name__ == "__main__":
    ...
    print("Double Bottom backtest done.")
